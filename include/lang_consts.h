...
std::array<std::string, 2048> portuguese_words = {
    "abacate",
    "abaixo",
    "abalar",
    "abater",
...
std::array<std::string, 2048> spanish_words = {
    "ábaco",
    "abdomen",
    "abeja",
    "abierto",
...
std::array<std::string, 2048> japanese_words = {
    "あいこくしん",
    "あいさつ",
    "あいだ",
    "あおぞら",
...
std::map<std::string, std::array<std::string, 2048>> langs = {
    {"chinese_simplified", chinese_simplified_words},
    {"chinese_traditional", chinese_traditional_words},
    {"czech", czech_words},
